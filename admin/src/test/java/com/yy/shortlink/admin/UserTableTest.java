package com.yy.shortlink.admin;

public class UserTableTest {

    private static String user_table = "CREATE TABLE `t_user_%d` (\n" +
    ...
    private static String link_table ="CREATE TABLE `t_link_%d` (\n" +
            "  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',\n" +
    ...
    private static String link_table1 = "DROP TABLE `t_link_%d`;";

    private static String group_table = "CREATE TABLE `t_group_%d` (\n" +
            "  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',\n" +
            "  `gid` varchar(32) DEFAULT NULL COMMENT '分组标识',\n" +
